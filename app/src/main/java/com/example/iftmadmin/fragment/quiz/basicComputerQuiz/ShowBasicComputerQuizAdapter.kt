...
class ShowBasicComputerQuizAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.basic_computer_quiz_cardview, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.question.text = "Qus.- " + basicComputerQuizModel.question
        holder.optionA.text = "1." + basicComputerQuizModel.optionA
        holder.optionB.text = "2." + basicComputerQuizModel.optionB
        holder.optionC.text = "3." + basicComputerQuizModel.optionC
        holder.optionD.text = "4." + basicComputerQuizModel.optionD
        holder.answer.text = "  " + basicComputerQuizModel.answer
    ...
    private fun showDialog(basicComputerQuizModel: BasicComputerQuizModel) {
        val databaseRef = FirebaseDatabase.getInstance().getReference("basicComputerQuiz")
